...
def get_indoor_external_sensor_temp() :
    ...
    if g_general_pars['read_external_indoor_sensor'] == "y" :
        ...
        if f0.exec_external_pgm("temp_reading", cmd) :
...
def cre_monthly_rates() :
    if is_last_day_this_month() or (g_general_pars['create_monthly_rates_when'] == "d"):
        ...
        if cre_new :
            ...
            f0.exec_external_pgm("monthly_rates", cmd)
...
if g_general_pars['use_hourly_rates'] == "y" or int(g_general_pars['hourly_rate_decrease_during_top_hours']) > 0 :
    if g_general_pars['external_pgm_create_hourly_rates'] != "," :
        ...
        hr_rates_decrease_active = create_hourly_rates()

if g_general_pars['create_hourly_rates'] == "y" and not hr_rates_decrease_active:
    create_hourly_rates()      # Could have already been tried above. No big deal to do it again.
